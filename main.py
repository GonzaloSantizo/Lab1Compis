...
def main():
    ...
    while True:
        ...
        postfix_regex = shun.exec(infix_regex)
        print("Cadena convertida a postfix: " + str(postfix_regex))
        print()

        # Convertimos la expresión a un AFN
        output_text_file = "texts/afn.txt"
        afn = thom.exec(postfix_regex, output_text_file)
        ...
        print("\nSimulador AFN: ")
        simAFN.exec(alfabeto, transiciones, estado_inicial, estados_aceptacion, cadena)
        ...
        simAFD.exec(alfabetocon, Dtran, estado_inicialcon, estado_finalcon, cadena)
